...
/** 查询组织列表 GET /department/queryOrgList */
export async function mesDepartmentQueryOrgList(
  // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
  params: MES.DepartmentQueryOrgListParams,
  options?: { [key: string]: any },
) {
  return request<MES.ResultVo_List_OrgDTO_>(`/mes/department/queryOrgList`, {
    method: 'GET',
    headers: {
      'Content-Type': 'multipart/form-data',
    },
