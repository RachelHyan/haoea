...
export default defineComponent({
  ...
  setup () {
    ...
    const params = reactive<any>({projectId,type:"Vehicle_operation",});
    const exportParams = reactive<any>({projectId,type:"Vehicle_operation",});
